...
export default function FloatingDecorations() {
  const elements = [
    { text: "{ }", top: "18%", left: "85%", rotate: 15, delay: "0s", duration: "18s", color: "from-teal- to-cyan-500" },
    { text: "JS", top: "35%", left: "5%", rotate: -20, delay: "-4s", duration: "22s", color: "from-yellow-400 to-amber-500" },
    { text: "TS", top: "50%", left: "80%", rotate: 10, delay: "-8s", duration: "20s", color: "from-teal- to-teal-500" },
