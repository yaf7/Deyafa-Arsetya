      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          >
            ...
            <div className="relative glass-card p-8 md:p-10 rounded-2xl border border-white/5 group-hover:border-white/10 transition-colors duration-500 ease-out h-full flex flex-col justify-between">
              <div>
              ...
              <div className="mt-auto">
                <a
                  ...
                  className="inline-flex items-center gap-2 text-sm font-bold bg-white text-black px-6 py-3 rounded-full hover:bg-blue-50 transition-colors duration-500 ease-out shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_25px_rgba(255,255,255,0.3)]"
                >
          ...
          >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="glass p-6 rounded-2xl flex items-center justify-between border border-white/5 hover:border-blue-500/50 hover:bg-white/5 transition-all duration-500 ease-out group"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="glass p-6 rounded-2xl flex items-center justify-between border border-white/5 hover:border-purple-500/50 hover:bg-white/5 transition-all duration-500 ease-out group"
            >
              <div className="flex items-center gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="glass p-6 rounded-2xl flex items-center justify-between border border-white/5 hover:border-green-500/50 hover:bg-white/5 transition-all duration-500 ease-out group"
            >
              <div className="flex items-center gap-4">
