...
export default function ScorpioConstellation() {
  ...
  useEffect(() => {
    ...
    const scorpioStars: ScorpioStar[] = [
      ...
      { name: "Deyafa Arsetya", scientificName: "Alpha Core (Full-Stack Developer)", astronomicalName: "Antares (α Sco)", rx: 0, ry: -5, size: 10.0, color: "#f97316", glowColor: "rgba(249, 115, 22, 0.8)", isHeart: true, info: "Pusat pengendali seluruh sistem portofolio. Fokus pada pengembangan Web & Mobile." },
